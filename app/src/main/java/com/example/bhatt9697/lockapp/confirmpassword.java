...
public class confirmpassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TRUE_CODE=getIntent().getExtras().getString("value");
...
//if(count==5) {
                        ...
                        if(x>=236&&x<=256&&y<=600&&y>=575) {
                            // tv.setText(codeString);
                            //editor.putString("user", codeString);
                            Toast.makeText(confirmpassword.this,"football", Toast.LENGTH_SHORT).show();
                            codeString2 += "0";
                            count++;
                        ...
                        if(x>=214&&x<=195&&y<465&&y>=445){
                            ...
                            Toast.makeText(confirmpassword.this,"Heart", Toast.LENGTH_SHORT).show();
                            codeString2 += "1";
                            count++;
                        ...
                        if(x>=50&&x<=69&&y<532&&y>=512) {
                            ...
                            Toast.makeText(confirmpassword.this,"tire", Toast.LENGTH_SHORT).show();
                            codeString2 += "2";
                            count++;
                        ...
                        if(x>=445&&x<=450&&y<756&&y>=745) {
                            ...
                            Toast.makeText(confirmpassword.this,"Buiscit", Toast.LENGTH_SHORT).show();
                            codeString2 += "3";
                            count++;

                        }

                        if(codeString2.length()==4){
                            if (codeString2.equals(TRUE_CODE)) {

                                Toast.makeText(getApplicationContext(),
                                        " password created succesfully!",
                                        Toast.LENGTH_SHORT).show();
                                editor.putString("PatternLock", codeString2);
                                editor.commit();

                                Intent intent = new Intent(confirmpassword.this, lockactivity.class);
...
//if(count==5) {
                        ...
                        if(x>=345&&x<=355&&y<957&&y>=945) {
                            ...
                            Toast.makeText(confirmpassword.this,"gun", Toast.LENGTH_SHORT).show();
                            codeString2 += "3";
                            count++;
